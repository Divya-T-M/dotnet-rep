...
namespace DemoProject.Models
{
    public class Employee
    {
        ...
        public double RevVar1 { get; set; }
        public double RevVar2 { get; set; }
        public double VolVar { get; set; }
        public double VolVar1 { get; set; }
        public double VolVar2 { get; set; }
        ...
        public List<SelectListItem> EmployeeList11 { get; set; } = new List<SelectListItem>();
